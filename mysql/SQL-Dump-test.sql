...
-- Löschen der abhängigen Tabellen
...
-- Neuanlegen der Tabelle 'Household'
CREATE TABLE Household (
    household_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

INSERT INTO Household (household_id) VALUES (1);

-- Neuanlegen der Tabelle 'users'
CREATE TABLE users (
...
-- Neuanlegen der Tabelle 'Groceries'
...
-- Neuanlegen der Tabelle 'Recipe_Groceries'
...
-- Neuanlegen der Tabelle 'Fridge'
CREATE TABLE Fridge (
    fridge_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

INSERT INTO Fridge(fridge_id) VALUES (1);

-- Neuanlegen der Tabelle 'Fridge_Groceries'
...
-- Neuanlegen der Tabelle 'ShoppingList'
